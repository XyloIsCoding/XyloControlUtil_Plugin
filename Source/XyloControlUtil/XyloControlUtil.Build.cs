...
public class XyloControlUtil : ModuleRules
{
	public XyloControlUtil(ReadOnlyTargetRules Target) : base(Target)
	{
		...
		PublicDependencyModuleNames.AddRange( new string[] { "Core" , "InputCore", "EnhancedInput", "ModularGameplay", "GameplayTags", "NetCore" /* ... add other public dependencies that you statically link with here ... */ } );
